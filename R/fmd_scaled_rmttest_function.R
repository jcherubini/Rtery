...
#' library(tidyverse)
#' dat <- tibble::tibble(pid = as.factor(rep(1:10, 2)), dpeak = rnorm(20, 4.27, 1.12), dbase = rnorm(20, 4.16, 1.21)*0.8, group = as.factor(c(rep("NS", 10), rep("SD", 10))))
#' dat <- dat %>%
#' arrange(pid)
#' fmd_scaled_rmttest(dat)
